...
export default class PostCard extends Component {
  ...
  refreshComments = () => {
    PostDataService.retrievePostComments(
      this.state.target,
      this.props.post.id
    ).then((res) => {
        ...
        <div className="status-head">
          <div className="status-left">
            ...
            <div style={{ float: "left" }}>
              ...
              <div className="date">
                {moment(this.props.post.targetDate).fromNow()}
              </div>
            </div>
          </div>
          {this.props.username ==
          AuthenticationService.getLoggedInUserName() ? (
            <div className="status-right">
              <OverlayTrigger
                placement={"bottom"}
                overlay={
                  <Tooltip id={"tooltip-bottom"}>Edit this post</Tooltip>
                }
              >
              ...
              <OverlayTrigger
                placement={"bottom"}
                overlay={
                  <Tooltip id={"tooltip-bottom"}>Delete this post</Tooltip>
                }
              >
                <Close
                  name="delete"
                  onClick={() =>
                    this.props.deletePostClicked(this.props.post.id)
                  }
                />
              </OverlayTrigger>
            </div>
        ...
        <div className="status-content">
          ...
          {this.state.show && (
            <Editable
              ...
              content={this.props.post.description}
